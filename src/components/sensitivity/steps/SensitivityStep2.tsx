...
interface Props {
    onNext: (temperature: number) => void;
    onPrev: () => void;
    initialValue?: number;
}

export default function SensitivityStep2({onNext, onPrev, initialValue = 19}: Props) {
            ...
            <div className="container mx-auto px-6 py-8">
                ...
                <div className="mb-8">
                    ...
                    <div className="w-full bg-white/20 rounded-full h-1.5">
                        <div className="bg-white rounded-full h-1.5 w-2/3 transition-all duration-300"></div>
                    </div>
                </div>

                {/* 메인 콘텐츠 */}
                <Card variant="elevated" padding="lg" className="mb-6 text-gray-900">
                    <CardHeader className="text-center">
                        <div className="text-5xl mb-4">🌡️</div>
                        <h2 className="text-2xl font-bold mb-2">긴팔을 입기 시작하는 온도는?</h2>
                        <p className="text-gray-600">개인별 쾌적 온도를 알려주세요</p>
                    </CardHeader>

                    <CardContent>
                        {/* 상황 설명 */}
                        <Card variant="outlined" padding="md" className="bg-blue-50 border-blue-200 text-center mb-8">
                            <div className="text-blue-600 font-semibold text-sm mb-2">🌤️ 상황</div>
                        ...
                        <div className="mb-10 px-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    style={{
                                        background: 'linear-gradient(90deg, #60a5fa 0%, #34d399 50%, #f87171 100%)'
                                    }}
                                />
                                <style jsx>{`
                        ...
                        {/* 가이드 텍스트 */}
                        <Card variant="outlined" padding="sm" className="bg-gray-50 border-l-4 border-blue-500">
